jQuery(document).ready(function () {
    ...
    function slideEffectAjax() {
        jQuery(".fl-cart-contain").mouseenter(function () {
            jQuery(this).find(".fl-cart-dropdown").stop(true, true).slideDown()
        }), jQuery(".fl-cart-contain").mouseleave(function () {
            jQuery(this).find(".fl-cart-dropdown").stop(true, true).slideUp()
        }),
            jQuery(".fl-notification-contain").mouseenter(function () {
                jQuery(this).find(".fl-notif-dropdown").stop(true, true).slideDown()
            }), jQuery(".fl-notification-contain").mouseleave(function () {
                jQuery(this).find(".fl-notif-dropdown").stop(true, true).slideUp()
            })
    }
